...
const BookDetails = (props) => {
  return (
    <View>
      <Text style={styles.BookDetailsTitle}>{props.title}</Text>
      <Text style={styles.BookDetailsValue}>{props.value}</Text>
    </View>
  );
};

const LentBooks = (props) => {
  ...
  return (
    <ScrollView>
      <SafeAreaView style={styles.main}>
        <Title style={styles.title}>LENT (1)</Title>

        <View style={styles.layout}>
          <View style={styles.fields}>
            <View>
              <BookDetails title={"Code"} value={"10235976015"} />
              <BookDetails title={"ISBN Code"} value={"9786890005"} />
              <BookDetails
                title={"Name of the book"}
                value={"Fault in our stars"}
              />
              <BookDetails title={"Author"} value={"John Green"} />
              <BookDetails title={"Price"} value={"700"} />
              <BookDetails title={"Condition"} value={"Good"} />
              <BookDetails title={"Status"} value={"Drop the book on Store"} />
            </View>
          </View>
        ...
        <View style={styles.shop}>
          <Text style={styles.BookDetailsTitle}>Shop</Text>
